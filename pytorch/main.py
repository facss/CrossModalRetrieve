...
def main():
    ...
    valdata=Data(None,None,opts.val_list_str,
                    None,val_transforms,None,opts.data_path,opts.num_classes)
    testdata=Data(None,opts.test_list_str,None,
                    None,None,test_transforms,opts.data_path,opts.num_classes)

    train_loader=DataLoader(traindata,batch_size=opts.batch_size,shuffle=True,num_workers=opts.workers,pin_memory=True)
    print('Training loader prepared')

    val_loader=DataLoader(valdata,batch_size=opts.batch_size,shuffle=False,num_workers=opts.workers,pin_memory=True)
